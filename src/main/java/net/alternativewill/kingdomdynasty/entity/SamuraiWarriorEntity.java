...
public class SamuraiWarriorEntity extends PathfinderMob {

    public SamuraiWarriorEntity(EntityType<? extends PathfinderMob> p_21683_, Level p_21684_) {
        ...
        this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(ModItems.KARUTA_KABUTO_RED.get()));
        this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(ModItems.KARUTA_DO_RED.get()));
        this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(ModItems.KARUTA_KUSAZURI_RED.get()));
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(ModItems.KARUTA_GETA_RED.get()));
    }

    public SamuraiWarriorEntity(PlayMessages.SpawnEntity spawnEntity, Level level) {
        this(ModEntityTypes.SAMURAIWARRIOR.get(), level);
    }
