...
public class KarutaArmorPinkModel extends AnimatedGeoModel<KarutaArmorPinkItem> {
    @Override
    public ResourceLocation getModelLocation(KarutaArmorPinkItem object) {
        return new ResourceLocation(KingdomDynasty.MOD_ID, "geo/karuta_armor.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(KarutaArmorPinkItem object) {
        return new ResourceLocation(KingdomDynasty.MOD_ID, "textures/models/armor/karuta/karuta_armor_pink.png") {
        };
    }

    @Override
    public ResourceLocation getAnimationFileLocation(KarutaArmorPinkItem animatable) {
